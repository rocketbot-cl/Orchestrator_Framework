...
|Mail de usuarios|Lista de e-mails de usuarios de NOC que tendrán acceso al Asset. Escríbalos sin comillas, entre corchetes y separados por coma.|[usuario1@mail.com, usuario2@mail.com]|
...
|Asignar resultado a Variable|Variable que recibe True si el Asset fue creado correctamente.|Variable|
...
|Nuevo nombre de Asset|Nuevo nombre del Asset. Déjelo vacío para conservar el nombre actual.|NuevoAsset|
|Nuevo token del proceso|Nuevo token del proceso propietario. Déjelo vacío para conservar el proceso actual.|27FEXKIXFRFDUNVD|
|Nueva key de la instancia|Nueva key de la instancia propietaria. Déjela vacía para conservar la instancia actual.|6241c3a1dd96f8f92f|
|Nuevos mails de usuarios|Nueva lista de e-mails de usuarios asociados. Escríbalos sin comillas, entre corchetes y separados por coma. Déjela vacía para conservar los usuarios actuales.|[usuario1@mail.com, usuario2@mail.com]|
|Nuevo tipo del Asset|Nuevo tipo del Asset text, password o encrypted. Déjelo vacío para conservar el tipo actual.|General|
|Nuevo valor del Asset|Nuevo valor que se almacenará en el Asset. Déjelo vacío para conservar el valor actual.|Un valor|
|Asignar resultado a Variable|Variable que recibe True si el Asset fue modificado correctamente.|Variable|
...
|Parámetros|Descripción|ejemplo|
| --- | --- | --- |
|Id del Asset|ID del Asset que se desea eliminar. Puede obtenerse con Obtener Asset Específico activando datos adicionales.|Id_Asset|
|Asignar a variable|Variable que recibe True si el Asset fue eliminado correctamente.|var|
